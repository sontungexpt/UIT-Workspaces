...
function FavouritePage({ route }: { route: any }) {
  ...
  useEffect(() => {
    const getDatas = async () => {
      try {
        const dataSaved = await AsyncStorage.getItem('data_31_3');
  ...
  return (
    <View style={[styles.homePage, scheme === 'dark' && styles.darkTheme]}>
