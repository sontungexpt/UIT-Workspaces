...
function HomePage({ navigation }: { navigation?: Object }): JSX.Element {
  const [products, setProducts] = useState([]);

  function handleLoadProducts(): void {
    LoadProducts((data: Object) => setProducts(data.assets));
  }

  function handlePressProduct(product: Object): void {
