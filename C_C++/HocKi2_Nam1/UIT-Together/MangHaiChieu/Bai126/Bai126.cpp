...
void DoQuickSortDescending(int[][MAXC], int, int, int, int, int);
void SapXepCotGiamDan(int[][MAXC], int, int, int&);
...
void DoQuickSortDescending(int a[][MAXC], int m, int n, int bottom, int top, int vtCot)
{
	if (bottom < top)
	{
		int par = FindParticipate(a, m, n, bottom, top, vtCot);
		DoQuickSortDescending(a, m, n, bottom, par, vtCot);
		DoQuickSortDescending(a, m, n, par + 1, top, vtCot);
	}
}

void SapXepCotGiamDan(int a[][MAXC], int m, int n, int& vtCot)
{
	cout << "Nhap vi tri cot can sap xep: ";
	cin >> vtCot;
	DoQuickSortDescending(a, m, n, 0, m - 1, vtCot);
}