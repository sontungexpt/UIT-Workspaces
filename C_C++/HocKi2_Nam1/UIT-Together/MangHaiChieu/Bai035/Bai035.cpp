...
bool ktDoiXung(int);
int TongDong(int[][MAXC], int, int, int);
...
int main()
{
	...
	cin >> k;
	int kq = TongDong(a, row, col, k);
	cout << "\nTong cac so doi xung tren dong " << k << " la: " << kq;
...
int TongDong(int a[][MAXC], int m, int n, int k)
{
	int s = 0;
