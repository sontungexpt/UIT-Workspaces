...
#pragma region Vector
		...
		case 14:
			...
			cin >> vector2;
			vector1 = vector2;
			cout << "\nVector 1 sau khi duoc gan bang vector hai la: "
				<< vector1;
			break;
		case 15:
			cout << "\nNhap vector 1: ";
			...
			cin >> vector2;
			if (vector1 == vector2)
				cout << "\nVector 1 bang vector 2";
			else
				cout << "\nVector 1 khong bang vector 2";
			break;
		case 16:
			cout << "\nNhap vector 1: ";
			cin >> vector1;
			...
			cin >> vector2;
			if (vector1 != vector2)
				cout << "\nVector 1 khac vector 2";
			else
				cout << "\nVector 1 khong khac vector 2";
			break;
#pragma endregion
